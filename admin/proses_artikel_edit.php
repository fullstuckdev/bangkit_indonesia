...
if($namafile == '') {
$update = mysqli_query($con, "UPDATE artikel SET judul ='$_POST[judul]', artikel='$_POST[artikel]', tanggal='$_POST[tanggal]', id_kategori='$_POST[kategori]' WHERE id_artikel ='$_POST[id_artikel]'");
